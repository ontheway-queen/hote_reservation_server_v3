...
class MConfigurationController extends AbstractController {
	...
	public getAllAccomodation = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } = await this.service.getAllAccomodation(
				req
			);
	...
	public getSingleAccomodation = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } = await this.service.getSingleAccomodation(
				req
			);
	...
	public createPermissionGroup = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } = await this.service.createPermissionGroup(
				req
			);
	...
	public getPermissionGroup = this.asyncWrapper.wrap(
		null,
		async (req: Request, res: Response) => {
			const { code, ...data } = await this.service.getPermissionGroup(
				req
			);
	...
	public getSingleHotelPermission = this.asyncWrapper.wrap(
		{
			paramSchema:
				this.commonValidator.singleParamValidator("hotel_code"),
		},
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.service.getSingleHotelPermission(req);
	...
	public updateSingleHotelPermission = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.service.updateSingleHotelPermission(req);
	...
	public createRoomTypeAmenitiesHead = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.service.createRoomTypeAmenitiesHead(req);
	...
	public getAllRoomTypeAmenitiesHead = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.service.getAllRoomTypeAmenitiesHead(req);
	...
	public updateRoomTypeAmenitiesHead = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.service.updateRoomTypeAmenitiesHead(req);
	...
	public createRoomTypeAmenities = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.service.createRoomTypeAmenities(req);
	...
	public getAllRoomTypeAmenities = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.service.getAllRoomTypeAmenities(req);
	...
	public updateRoomTypeAmenities = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.service.updateRoomTypeAmenities(req);
	...
	public deleteRoomTypeAmenities = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.service.deleteRoomTypeAmenities(req);
