...
class RestaurantFoodValidator {
  ...
  public createFoodV2Validator = Joi.object({
    food: Joi.string()
      .required()
      .custom((value, helper) => {
        let parsed;
        ...
        const schema = Joi.object({
          ...
          serving_quantity: Joi.number().optional(),
          linked_inventory_item_id: Joi.number().optional(),
  ...
  public preparedFoodValidator = Joi.object({
    prepared_food: Joi.array().items(
      Joi.object({
  ...
  public getFoodStocksValidator = Joi.object({
    limit: Joi.number().optional(),
    skip: Joi.number().optional(),
  ...
  public updateFoodV2Validator = Joi.object({
    food: Joi.string()
      .required()
      .custom((value, helper) => {
        let parsed;
