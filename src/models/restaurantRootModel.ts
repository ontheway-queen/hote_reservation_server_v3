...
import RestaurantStaffModel from "./restaurantModels/restaurant.staff.model";
...
export class RestaurantModels {
  ...
  public restaurantStaffModel(trx?: Knex.Transaction) {
    return new RestaurantStaffModel(trx || this.db);
  }
}
