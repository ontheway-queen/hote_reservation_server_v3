...
export class SubReservationService extends AbstractServices {
  ...
  public async createGroupRoomBookingFolios({
    ...
    if (body.is_payment_given && body.payment?.amount > 0) {
      ...
      // insert money receipt DAta: body.payment.amount, method, received_by, payment_date, booking_ref, note

      // insert folio money receipt, folio_id, money_receipt_id, amount
