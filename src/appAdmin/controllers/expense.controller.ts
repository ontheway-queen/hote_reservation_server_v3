...
class ExpenseController extends AbstractController {
	...
	public createExpenseHead = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.expenseService.createExpenseHead(req);
	...
	public getAllExpenseHead = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.expenseService.getAllExpenseHead(req);
	...
	public updateExpenseHead = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.expenseService.updateExpenseHead(req);
	...
	public deleteExpenseHead = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.expenseService.deleteExpenseHead(req);
	...
	public getAllExpense = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } = await this.expenseService.getAllExpense(
				req
			);
			res.status(code).json(data);
		}
	...
	public getSingleExpense = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.expenseService.getSingleExpense(req);
