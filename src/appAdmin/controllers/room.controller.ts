...
class RoomController extends AbstractController {
	...
	public getAllRoomByRoomStatus = this.asyncWrapper.wrap(
		{
			querySchema:
				this.roomvalidator.getAllHotelRoomByRoomStatusQueryValidator,
		},
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.roomService.getAllRoomByRoomStatus(req);
			res.status(code).json(data);
		}
	);
	...
	public getAllRoomByRoomTypes = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.roomService.getAllRoomByRoomTypes(req);
			res.status(code).json(data);
		}
	);
	...
	public getAllAvailableRooms = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.roomService.getAllAvailableRooms(req);
			res.status(code).json(data);
		}
	);
	...
	public deleteHotelRoom = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } = await this.roomService.deleteHotelRoom(
				req
			);
			res.status(code).json(data);
		}
	...
	public updateHotelRoomStatus = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } = await this.roomService.updateRoomStatus(
				req
			);
			res.status(code).json(data);
		}
	...
	public getAllRoomByRoomType = this.asyncWrapper.wrap(
		{
			paramSchema:
				this.commonValidator.singleParamValidator("room_type_id"),
		},
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.roomService.getAllRoomByRoomType(req);
			res.status(code).json(data);
		}
	);
	...
	public getAllOccupiedRooms = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.roomService.getAllOccupiedRooms(req);
			res.status(code).json(data);
		}
	);
	...
	public createMultipleRooms = this.asyncWrapper.wrap(
		...
		async (req: Request, res: Response) => {
			const { code, ...data } =
				await this.roomService.createMultipleRooms(req);
			res.status(code).json(data);
		}
	);
}
