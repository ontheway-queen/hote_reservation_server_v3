    ...
    <div class="email-container">
        ...
        <div class="header">
            <div class="header-content">
                <div class="logo-container">
                    <img src="${projectLogo}" alt="${projectName}" class="logo">
                </div>
        ...
        <div class="content">
            ...
            <div class="signature">
                ...
                <div class="signature-brand">${projectName}</div>
        ...
        <div class="footer">
            <div class="footer-content">
                ...
                <a href="${projectURL}" class="footer-link" target="_blank">${companyURL}</a>
