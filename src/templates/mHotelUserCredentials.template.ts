...
<head>
    ...
    <title>Welcome to ${projectName} - Account Activation</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="email-wrapper">
            ...
            <div class="support-section">
                ...
                <div class="support-grid">
                    ...
                    <div class="support-item">
                        ...
                        <div class="support-value"><a href="${projectURL}" target="_blank">www.m360ict.org</a></div>
                    </div>
                </div>
            </div>
        ...
        <div class="footer">
            <div class="footer-content">
                ...
                <a href="${projectURL}" class="footer-link" target="_blank">www.m360ict.org</a>
            </div>
        </div>
