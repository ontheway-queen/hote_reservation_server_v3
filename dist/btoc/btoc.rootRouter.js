...
class BtocRootRouter {
    ...
    callRouter() {
        ...
        this.router.use("/configuration", this.authChecker.whiteLabelTokenVerfiy, this.authChecker.btocUserAuthChecker, new btocConfig_router_1.BtocConfigRouter().router);
    }
}
