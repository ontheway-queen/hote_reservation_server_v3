...
class SubBtocHotelService extends abstract_service_1.default {
    ...
    createMainBooking({ payload, hotel_code, guest_id, sub_total, total_amount, total_nights, }) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ref = lib_1.default.generateBookingReferenceWithId(`WEB`, lastId);
    ...
    insertBookingRooms({ booked_room_types, booking_id, hotel_code, is_checked_in, }) {
        return __awaiter(this, void 0, void 0, function* () {
...
//# sourceMappingURL=btoc.sub.hotel.service.js.map