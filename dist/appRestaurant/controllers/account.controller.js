...
const account_validator_1 = __importDefault(require("../utils/validator/account.validator"));
class RestaurantAccountController extends abstract_controller_1.default {
    constructor() {
        super();
        ...
        this.createAccount = this.asyncWrapper.wrap({ bodySchema: this.Validator.createAccountValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.Service.createAccount(req), { code } = _a, data = __rest(_a, ["code"]);
        ...
        this.updateAccount = this.asyncWrapper.wrap({ bodySchema: this.Validator.updateAccountValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _c = yield this.Service.updateAccount(req), { code } = _c, data = __rest(_c, ["code"]);
            res.status(code).json(data);
        }));
        // balance transfer
        this.balanceTransfer = this.asyncWrapper.wrap({ bodySchema: this.Validator.balanceTransferValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _d = yield this.Service.balanceTransfer(req), { code } = _d, data = __rest(_d, ["code"]);
            res.status(code).json(data);
        }));
    }
}
exports.default = RestaurantAccountController;
