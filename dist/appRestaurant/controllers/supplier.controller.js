...
const supplier_validator_1 = __importDefault(require("../utils/validator/supplier.validator"));
class SupplierController extends abstract_controller_1.default {
    constructor() {
        super();
        this.Service = new supplier_service_1.default();
        this.Validator = new supplier_validator_1.default();
        //=================== Supplier Controller ======================//
        // create Supplier
        ...
        this.updateSupplier = this.asyncWrapper.wrap({ bodySchema: this.Validator.UpdateSupplierValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _c = yield this.Service.updateSupplier(req), { code } = _c, data = __rest(_c, ["code"]);
            res.status(code).json(data);
        }));
        // Delete Supplier
        this.deleteSupplier = this.asyncWrapper.wrap({ paramSchema: this.commonValidator.singleParamValidator() }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _d = yield this.Service.deleteSupplier(req), { code } = _d, data = __rest(_d, ["code"]);
            res.status(code).json(data);
        }));
    }
}
