...
const admin_role_service_1 = __importDefault(require("../services/admin-role.service"));
const administrator_validator_1 = __importDefault(require("../utils/validator/administrator.validator"));
class AdministrationResController extends abstract_controller_1.default {
    constructor() {
        super();
        this.administrationService = new admin_role_service_1.default();
        this.administratorValidator = new administrator_validator_1.default();
        // get all permission
        ...
        // create role
        this.createRole = this.asyncWrapper.wrap({
        ...
        this.updateResAdmin = this.asyncWrapper.wrap({ bodySchema: this.administratorValidator.updateRestaurantAdminValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _j = yield this.administrationService.updateResAdmin(req), { code } = _j, data = __rest(_j, ["code"]);
            res.status(code).json(data);
        }));
        // get All Employee
        this.getAllEmployee = this.asyncWrapper.wrap({ querySchema: this.administratorValidator.getAllEmployeeQueryValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _k = yield this.administrationService.getAllEmployee(req), { code } = _k, data = __rest(_k, ["code"]);
            res.status(code).json(data);
        }));
    }
}
exports.default = AdministrationResController;
