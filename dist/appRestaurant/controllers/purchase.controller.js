...
const purchase_validator_1 = __importDefault(require("../utils/validator/purchase.validator"));
class PurchaseController extends abstract_controller_1.default {
    constructor() {
        super();
        this.Service = new purchase_service_1.default();
        this.Validator = new purchase_validator_1.default();
        // create Purchase
        this.createPurchase = this.asyncWrapper.wrap({ bodySchema: this.Validator.createPurchaseValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.Service.createPurchase(req), { code } = _a, data = __rest(_a, ["code"]);
            res.status(code).json(data);
        }));
        // get All Purchase
        this.getAllPurchase = this.asyncWrapper.wrap({ querySchema: this.Validator.getAllPurchaseQueryValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.getSinglePurchase = this.asyncWrapper.wrap({ paramSchema: this.commonValidator.singleParamValidator() }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _d = yield this.Service.getSinglePurchase(req), { code } = _d, data = __rest(_d, ["code"]);
            res.status(code).json(data);
        }));
    }
}
