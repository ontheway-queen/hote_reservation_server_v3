...
const invoice_validator_1 = __importDefault(require("../../appAdmin/utlis/validator/invoice.validator"));
class InvoiceController extends abstract_controller_1.default {
    constructor() {
        ...
        //=================== Invoice Controller ======================//
        // get all invoice
        this.getAllInvoice = this.asyncWrapper.wrap({ querySchema: this.validator.getAllInvoiceValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.Service.getAllInvoice(req), { code } = _a, data = __rest(_a, ["code"]);
        ...
        this.getSingleInvoice = this.asyncWrapper.wrap({ paramSchema: this.commonValidator.singleParamValidator() }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _b = yield this.Service.getSingleInvoice(req), { code } = _b, data = __rest(_b, ["code"]);
            res.status(code).json(data);
        }));
    }
}
