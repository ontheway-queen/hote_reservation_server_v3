...
exports.newResutaurantUserAccount = void 0;
const tamplateConstants_1 = require("./tamplateConstants");
const newResutaurantUserAccount = (email, password, name) => {
    return `<!DOCTYPE html>
  <html>
    <head>
      <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
      <meta name="viewport" content="width=device-width, initial-scale=1.0" />
      <title>${tamplateConstants_1.rProjectName} MEMBER</title>
        <style>
...
Respected dear <strong>${name},</strong><p> 
      ...
      <div style="text-align: left">
                      ...
                      <div
                        ...
                        "
                      >
                        <a href="${tamplateConstants_1.rProjectURL}" style="padding-bottom: 16px; text-decoration: none; font-weight: bold;">https://www.m360ict.org<a/>
                      </div>
      <p>Best regards,</p>
      <p>M360ICT</p>
  </div>
...
exports.newResutaurantUserAccount = newResutaurantUserAccount;
//# sourceMappingURL=restaurantCredential.template.js.map