...
const newHotelUserAccount = (email, password, name) => {
  ...
  <html>
    <head>
      ...
      <title>${tamplateConstants_1.projectName} MEMBER</title>
        <style>
...
Respected dear <strong>${name},</strong><p> 
      <br/>
        Welcome to the web world of Reservation! Your Hotel Reservation account has been created successfully.</p>
        <br/>
        <p><strong>Web Link: </strong> <a href="https://www.hotels.hotel360.world/" target="_blank">https://www.hotels.hotel360.world/</a></p> <br/>
      ...
      <div style="text-align: left">
                      ...
                      <div
                        ...
                        "
                      >
                        <a href="${tamplateConstants_1.projectURL}" style="padding-bottom: 16px; text-decoration: none; font-weight: bold;">https://www.m360ict.org<a/>
                      </div>
      <p>Best regards,</p>
      <p>M360ICT</p>
  </div>
