...
const derived_reservation_service_1 = require("./derived.reservation.service");
const subreservation_service_1 = require("./subreservation.service");
class ReservationService extends derived_reservation_service_1.DerivedReservationService1 {
    constructor() {
        super();
    }
    calendar(req) {
