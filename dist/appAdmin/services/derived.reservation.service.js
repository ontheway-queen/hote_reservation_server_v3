        ...
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (booking.is_individual_booking) {
                    yield sub.changeDateOfBookingForIndividual({
                        booking,
                        nights,
                        booking_id,
                        booking_rooms,
                    ...
                    yield sub.changeDateOfBookingForGroupReservation({
                        booking,
                        nights,
                        booking_id,
                        booking_rooms,
    ...
    changeRoomOfAReservation(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (booking.is_individual_booking) {
                    yield sub.changeRoomOfAIndividualReservation({
                        body: req.body,
                        booking,
                        booking_id,
                    ...
                    yield sub.changeRoomOfAGroupReservation({
                        body: req.body,
                        booking,
                        booking_id,
                        new_rooms_rm_type_id,
