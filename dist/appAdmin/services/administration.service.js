...
class AdministrationService extends abstract_service_1.default {
    ...
    getAllAdmin(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { data, total } = yield this.Model.rAdministrationModel().getAllAdmin({
                hotel_code,
                limit: Number(limit),
                skip: Number(skip),
                status: status,
    ...
    getAllPermission(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { permissions } = yield model.getHotelPermissionViewByHotel({
                hotel_code,
            });
    ...
    createRole(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                // get all permission
                const checkAllPermission = yield model.getHotelAllPermissionByHotel({
                    ids: permissionIds,
                    hotel_code,
                });
                ...
                for (let i = 0; i < permissions.length; i++) {
                    rolePermissionPayload.push(Object.assign(Object.assign({ hotel_code, role_id: res[0].id }, permissions[i]), { h_permission_id: permissions[i].h_permission_id, created_by: id }));
                }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (updated_permissions.length) {
                    const updatePermissionIds = updated_permissions.map((item) => item.h_permission_id);
                    ...
                    if (newPermission.length) {
                        for (let i = 0; i < updated_permissions.length; i++) {
                            if (newPermission.includes(updated_permissions[i].h_permission_id)) {
                                newPermissionPayload.push(Object.assign(Object.assign({ hotel_code, role_id: parseInt(role_id) }, updated_permissions[i]), { h_permission_id: updated_permissions[i].h_permission_id, created_by: admin_id }));
                            }
                        }
                    }
                    // insert role permission
                    ...
                    if (existingPermissionIds.length) {
                        for (let i = 0; i < updated_permissions.length; i++) {
                            if (existingPermissionIds.includes(updated_permissions[i].h_permission_id)) {
