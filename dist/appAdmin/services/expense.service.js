    ...
    createExpense(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const accVourcherRes = yield accountModel.insertAccVoucher([
                    {
                ...
                const payload = Object.assign(Object.assign({}, rest), { expense_no: expenseNo, hotel_code,
                    created_by, expense_amount: total_amount, acc_voucher_id: accVourcherRes[1].id });
                ...
                //   },
                // ]);
                const expenseItemPayload = yield Promise.all(expense_items.map((ei) => __awaiter(this, void 0, void 0, function* () {
    ...
    updateExpenseService(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (Array.isArray(expense_items) && expense_items.length) {
                    // voucher IDs
                    const voucherIds = expense.expense_items.map((vc) => vc.expense_head_id);
                    // delete vouchers
                    yield accountModel.deleteAccVoucherByIds(voucherIds);
                    // delete expense item
                    yield expenseModel.deleteExpenseItem(expenseId);
                    const modifiedExpenseItems = expense_items.filter((item) => !item.is_deleted);
                    // ___________________________________  Accounting _________________________________//
                    // accounting
                    const helper = new helperFunction_1.HelperFunction();
                    const hotelModel = this.Model.HotelModel(trx);
                    ...
                    const expenseItemPayload = yield Promise.all(modifiedExpenseItems.map((ei) => __awaiter(this, void 0, void 0, function* () {
                        const voucherRes = yield accountModel.insertAccVoucher([
                            {
                                acc_head_id: ei.expense_head_id,
                                created_by: req.hotel_admin.id,
                    ...
                    const expenseAmount = modifiedExpenseItems.reduce((acc, cu) => acc + Number(cu.amount || 0), 0);
                    yield accountModel.updateAccVoucher({
                        credit: expenseAmount,
                        description: `Balance credited for expense ${expenseNo}`,
                    }, { hotel_code, id: expense.acc_voucher_id });
                    yield expenseModel.createExpenseItem(expenseItemPayload);
