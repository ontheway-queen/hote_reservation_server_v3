...
class ReservationRootRouter {
    ...
    callRouter() {
        ...
        //   new ReservationRootRouter().router
        // );
        // room booking router
        this.router.use("/room-booking", this.authChecker.hotelAdminAuthChecker, new room_booking_router_1.default().router);
        // setting router
