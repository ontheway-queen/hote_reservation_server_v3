...
class AdministrationController extends abstract_controller_1.default {
    constructor() {
        ...
        this.updateAdmin = this.asyncWrapper.wrap(null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _h = yield this.administrationService.updateAdmin(req), { code } = _h, data = __rest(_h, ["code"]);
            if (data.success) {
                res.status(code).json(data);
            }
            else {
        ...
        this.getAllAdmin = this.asyncWrapper.wrap({ querySchema: this.administratorValidator.getAllAdminQueryValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _j = yield this.administrationService.getAllAdmin(req), { code } = _j, data = __rest(_j, ["code"]);
            res.status(code).json(data);
        }));
    }
}
