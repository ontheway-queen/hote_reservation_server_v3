...
class HallBookingReportController extends abstract_controller_1.default {
    constructor() {
        ...
        this.getHallBookingReport = this.asyncWrapper.wrap({ querySchema: this.reportValidator.getHallBookingQueryValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.hallBookingReportService.getHallBookingReport(req), { code } = _a, data = __rest(_a, ["code"]);
