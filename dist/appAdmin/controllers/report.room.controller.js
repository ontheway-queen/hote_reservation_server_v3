...
class RoomReportController extends abstract_controller_1.default {
    constructor() {
        ...
        // get room Report
        this.getRoomReport = this.asyncWrapper.wrap({ querySchema: this.reportValidator.getAllHotelRoomQueryValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.roomReportService.getRoomReport(req), { code } = _a, data = __rest(_a, ["code"]);
