...
class ExpenseReportController extends abstract_controller_1.default {
    constructor() {
        ...
        this.getExpenseReport = this.asyncWrapper.wrap({ querySchema: this.reportvalidator.getAllExpenseQueryValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.expenseReportService.getExpenseReport(req), { code } = _a, data = __rest(_a, ["code"]);
