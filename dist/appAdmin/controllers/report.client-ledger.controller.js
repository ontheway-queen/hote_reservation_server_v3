...
class ClientLedgerReportController extends abstract_controller_1.default {
    constructor() {
        ...
        this.getClientLedgerReport = this.asyncWrapper.wrap({ querySchema: this.reportValidator.getClientLedgerQueryValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.Service.getClientLedgerReport(req), { code } = _a, data = __rest(_a, ["code"]);
