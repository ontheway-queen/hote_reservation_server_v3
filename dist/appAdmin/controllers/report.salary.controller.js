...
class SalaryExpenseReportController extends abstract_controller_1.default {
    constructor() {
        ...
        // get salary report
        this.getSalaryReport = this.asyncWrapper.wrap({ querySchema: this.salaryReportValidator.getSalaryReportQueryValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.service.getSalaryReport(req), { code } = _a, data = __rest(_a, ["code"]);
