...
class RoomSettingController extends abstract_controller_1.default {
    constructor() {
        ...
        this.createFloorSetup = this.asyncWrapper.wrap({ bodySchema: this.settingValidator.createFloorSetupValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _q = yield this.roomSettingService.createFloorSetup(req), { code } = _q, data = __rest(_q, ["code"]);
            res.status(code).json(data);
        }));
        this.getAllFloorSetup = this.asyncWrapper.wrap(null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _r = yield this.roomSettingService.getAllFloorSetup(req), { code } = _r, data = __rest(_r, ["code"]);
            res.status(code).json(data);
        }));
        this.updateFloorSetup = this.asyncWrapper.wrap({ bodySchema: this.settingValidator.updateFloorSetupValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _s = yield this.roomSettingService.updateFloorSetup(req), { code } = _s, data = __rest(_s, ["code"]);
            res.status(code).json(data);
        }));
        this.deleteFloorSetup = this.asyncWrapper.wrap({ paramSchema: this.commonValidator.singleParamValidator() }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _t = yield this.roomSettingService.deleteFloorSetup(req), { code } = _t, data = __rest(_t, ["code"]);
            res.status(code).json(data);
        }));
        //=================== Building Setup Controller ======================//
        this.createBuildingSetup = this.asyncWrapper.wrap({ bodySchema: this.settingValidator.createBuildingSetupValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _u = yield this.roomSettingService.createBuildingSetup(req), { code } = _u, data = __rest(_u, ["code"]);
            res.status(code).json(data);
        }));
        this.getAllBuildingSetup = this.asyncWrapper.wrap(null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _v = yield this.roomSettingService.getAllBuildingSetup(req), { code } = _v, data = __rest(_v, ["code"]);
            res.status(code).json(data);
        }));
        this.updateBuildingSetup = this.asyncWrapper.wrap({ bodySchema: this.settingValidator.updateBuildingSetupValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _w = yield this.roomSettingService.updateBuildingSetup(req), { code } = _w, data = __rest(_w, ["code"]);
            res.status(code).json(data);
        }));
        this.deleteBuildingSetup = this.asyncWrapper.wrap({ paramSchema: this.commonValidator.singleParamValidator() }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _x = yield this.roomSettingService.deleteBuildingSetup(req), { code } = _x, data = __rest(_x, ["code"]);
            res.status(code).json(data);
        }));
    }
}
