...
class RoomBookingReportController extends abstract_controller_1.default {
    constructor() {
        ...
        // get account Report
        this.getRoomBookingReport = this.asyncWrapper.wrap({ querySchema: this.reportValidator.getAllHotelRoomBookingQueryValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.roomBookingReportService.getRoomBookingReport(req), { code } = _a, data = __rest(_a, ["code"]);
