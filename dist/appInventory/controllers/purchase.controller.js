...
const purchase_validator_1 = __importDefault(require("../utils/validation/purchase.validator"));
class PurchaseInvController extends abstract_controller_1.default {
    constructor() {
        super();
...
exports.default = PurchaseInvController;
