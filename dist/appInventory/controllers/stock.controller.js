...
const stock_validator_1 = __importDefault(require("../utils/validation/stock.validator"));
class StockInvController extends abstract_controller_1.default {
    constructor() {
        super();
        ...
        // Get All Purchase
        this.getAllStock = this.asyncWrapper.wrap({ querySchema: this.validator.getAllStockInvValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _b = yield this.service.getAllStock(req), { code } = _b, data = __rest(_b, ["code"]);
            res.status(code).json(data);
        }));
        // get single Purchase
        this.getSingleStock = this.asyncWrapper.wrap({ paramSchema: this.commonValidator.singleParamValidator() }, (req, res) => __awaiter(this, void 0, void 0, function* () {
