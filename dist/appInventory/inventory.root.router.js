...
const common_inv_router_1 = __importDefault(require("./routers/common.inv.router"));
...
const stock_router_1 = __importDefault(require("./routers/stock.router"));
class HotelInventoryRouter extends abstract_router_1.default {
    ...
    callRouter() {
        ...
        // inventory
        this.router.use("/inventory", new inventory_router_1.default().router);
    }
}
exports.default = HotelInventoryRouter;
//# sourceMappingURL=inventory.root.router.js.map