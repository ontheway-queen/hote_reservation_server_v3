    ...
    getAllEmployee(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield dtbs
                .select("e.id", "e.photo", "e.name", "e.email", "e.contact_no", this.db.raw("JSON_AGG(JSON_BUILD_OBJECT('id', d.id, 'name', d.name)) as department"), this.db.raw(`TO_CHAR(e.joining_date, 'YYYY-MM-DD') as joining_date`), "e.salary", "e.status", "de.name as designation_name", "de.id as designation_id")
