...
class ReportModel extends schema_1.default {
    ...
    getRoomBookingReport({ hotel_code, from_date, to_date, booking_type, status, limit, skip, }) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
