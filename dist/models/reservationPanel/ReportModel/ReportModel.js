...
class ReportModel extends schema_1.default {
    ...
    getAccHeadsForSelect(hotel_code) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db("acc_heads AS ah")
                .withSchema(this.ACC_SCHEMA)
                .select("ah.hotel_code", "ah.id AS head_id", "ah.parent_id AS head_parent_id", "ah.code AS head_code", "ah.group_code AS head_group_code", "ah.name AS head_name", "aph.code AS parent_head_code", "aph.name AS parent_head_name")
    ...
    getAllReservationByRoom({ hotel_code, checkin, checkout, booking_type, status, limit, skip, room_id, }) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
