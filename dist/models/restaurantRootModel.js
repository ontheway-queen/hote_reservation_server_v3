...
const restaurant_staff_model_1 = __importDefault(require("./restaurantModels/restaurant.staff.model"));
...
class RestaurantModels {
    ...
    restaurantStaffModel(trx) {
        return new restaurant_staff_model_1.default(trx || this.db);
    }
}
