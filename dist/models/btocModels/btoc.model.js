    ...
    getSingleUser(query) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db("users as u")
                .withSchema(this.BTOC_SCHEMA)
                .select("u.id", "u.first_name", "u.last_name", "u.email", "u.phone", "u.photo", "u.password", "u.status", "u.gender", "u.address", "u.date_of_birth", "city.city_name as city", "country.country_name as country", "u.is_deleted")
