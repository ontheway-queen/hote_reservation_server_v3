    ...
    getAllBooking({ hotel_code, limit, search, skip, }) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield this.db("bookings as b")
                ...
                .select("b.id as booking_id", "b.hotel_code", "b.booking_reference", this.db.raw(`TO_CHAR(b.check_in, 'YYYY-MM-DD') as check_in`), this.db.raw(`TO_CHAR(b.check_out, 'YYYY-MM-DD') as check_out`), "b.booking_type", "b.status", "b.is_individual_booking", "g.id as guest_id", this.db.raw(`CONCAT(g.first_name, ' ', g.last_name) as guest_name`), "g.email as guest_email", "g.phone as guest_phone", "br.id as booking_room_id", "br.room_id", "r.room_name", "br.room_type_id", "rt.name as room_type_name")
