    ...
    getOrders(query) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield baseQuery
                .clone()
                .select("o.id", "o.hotel_code", "o.restaurant_id", "o.table_id", "rt.name as table_name", "o.order_type", "o.status", "o.kitchen_status", "o.created_at", "o.net_total", "o.discount", "o.service_charge", "o.sub_total", "o.vat_amount", "o.grand_total", "ua.id as created_by_id", "ua.name as created_by_name")
                .orderBy("o.id", "desc")
