...
const res_hotel_service_1 = __importDefault(require("../services/res.hotel.service"));
const res_common_validator_1 = __importDefault(require("../utils/validator/res.common.validator"));
class RestaurantHotelController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new res_hotel_service_1.default();
        this.validator = new res_common_validator_1.default();
        this.geAllBookings = this.asyncWrapper.wrap({}, (req, res) => __awaiter(this, void 0, void 0, function* () {
...
//# sourceMappingURL=res.hotel.controller.js.map