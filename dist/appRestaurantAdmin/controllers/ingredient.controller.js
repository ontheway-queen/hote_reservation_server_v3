...
class RestaurantIngredientController extends abstract_controller_1.default {
    constructor() {
        super();
        this.validator = new ingredient_validator_1.default();
        this.service = new ingredient_service_1.default();
        this.createMeasurement = this.asyncWrapper.wrap({ bodySchema: this.validator.createIngredientValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.service.createMeasurement(req), { code } = _a, data = __rest(_a, ["code"]);
            res.status(code).json(data);
        }));
        this.getIngredients = this.asyncWrapper.wrap({ querySchema: this.validator.getIngredientsValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _b = yield this.service.getIngredients(req), { code } = _b, data = __rest(_b, ["code"]);
            res.status(code).json(data);
        }));
        this.updateIngredient = this.asyncWrapper.wrap({
        ...
        this.deleteIngredient = this.asyncWrapper.wrap({
            paramSchema: this.commonValidator.singleParamStringValidator(),
        }, (req, res) => __awaiter(this, void 0, void 0, function* () {
...
exports.default = RestaurantIngredientController;
