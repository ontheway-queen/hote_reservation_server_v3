...
const res_administration_service_1 = __importDefault(require("../services/res.administration.service"));
const res_administration_validator_1 = __importDefault(require("../utils/validator/res.administration.validator"));
class ResAdministrationController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new res_administration_service_1.default();
        this.validator = new res_administration_validator_1.default();
        // get all permission
...
exports.default = ResAdministrationController;
//# sourceMappingURL=res.administration.controller.js.map