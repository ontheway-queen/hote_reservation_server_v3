...
class BtocUserAuthService extends abstract_service_1.default {
    ...
    registration(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newUserData = Object.assign({ email, password: hashedPassword, photo: photoUrl }, rest);
    ...
    login(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { password: hashPass } = user, rest = __rest(user, ["password"]);
            ...
            const token = lib_1.default.createToken(tokenPayload, config_1.default.JWT_SECRET_BTOC_USER, "24h");
            return {
                success: true,
                code: this.StatusCode.HTTP_OK,
    ...
    forgetPassword(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tokenVerify = lib_1.default.verifyToken(token, config_1.default.JWT_SECRET_BTOC_USER);
            if (!tokenVerify) {
                return {
                    success: false,
                    code: this.StatusCode.HTTP_UNAUTHORIZED,
...
//# sourceMappingURL=auth.btoc-user.service.js.map