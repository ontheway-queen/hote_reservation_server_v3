...
const mAuth_admin_service_1 = __importDefault(require("../services/mAuth.admin.service"));
const mAuth_validator_1 = __importDefault(require("../utils/validator/mAuth.validator"));
const schema_1 = __importDefault(require("../../utils/miscellaneous/schema"));
class MAdminAuthController extends abstract_controller_1.default {
    constructor() {
        super();
        this.mAdminAuthService = new mAuth_admin_service_1.default();
        this.commonService = new commonServices_1.default();
        this.mAuthValidator = new mAuth_validator_1.default();
        // login
        this.login = this.asyncWrapper.wrap(null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { email, password } = req.body;
            const _a = yield this.mAdminAuthService.login({
                email,
                password,
        ...
        this.getProfile = this.asyncWrapper.wrap(null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _b = yield this.mAdminAuthService.getProfile(req), { code } = _b, data = __rest(_b, ["code"]);
            res.status(code).json(data);
        }));
        // update profile
        this.updateProfile = this.asyncWrapper.wrap({ bodySchema: this.mAuthValidator.updateProfileValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _c = yield this.mAdminAuthService.updateProfile(req), { code } = _c, data = __rest(_c, ["code"]);
            if (data.success) {
                res.status(code).json(data);
            }
            else {
        ...
        this.forgetPassword = this.asyncWrapper.wrap({ bodySchema: this.commonValidator.forgetPasswordValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const _d = yield this.mAdminAuthService.forgetService({
                token,
                email,
                password,
        ...
        this.changeAdminPassword = this.asyncWrapper.wrap({ bodySchema: this.commonValidator.changePasswordValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const _e = yield this.commonService.userPasswordVerify({
                ...
                userId: id,
                userIdField,
                schema: new schema_1.default().M_SCHEMA,
...
exports.default = MAdminAuthController;
//# sourceMappingURL=mAuth.admin.controller.js.map