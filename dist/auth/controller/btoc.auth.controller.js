...
class BtocUserAuthController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new btoc_auth_service_1.default();
        this.validator = new user_auth_validator_1.BtocUserAuthValidator();
        this.commonService = new commonServices_1.default();
        // registration
        this.registration = this.asyncWrapper.wrap({ bodySchema: this.validator.registrationValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _a = yield this.service.registration(req), { code } = _a, data = __rest(_a, ["code"]);
...
//# sourceMappingURL=btoc.auth.controller.js.map